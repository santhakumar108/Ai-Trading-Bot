"""
Symbol -> full legal company name, for display purposes only (e.g. the
customer dashboard showing "Prism Johnson Limited" instead of just the
ticker "PRSMJOHNSN.NS"). Sourced from the same NSE official archive as
config/nse_all_equity.py (archives.nseindia.com/content/equities/EQUITY_L.csv,
2026-09-19 snapshot) -- real company names, not fabricated. A symbol not
in this dict (e.g. one listed after this snapshot) falls back to showing
its raw ticker -- callers should use .get(symbol, symbol) or equivalent,
never assume every symbol resolves.
"""
...
NSE_COMPANY_NAMES: Dict[str, str] = {
    ...
    "3BBLACKBIO.NS": "3B Blackbio Dx Limited",
    ...
    "AASTHA.NS": "Aastha Spintex Limited",
    "AAVAS.NS": "Aavas Financiers Limited",
    "ABANSENT.NS": "Abans Enterprises Limited",
    ...
    "ABMKNO.NS": "ABM Knowledgeware Limited",
    ...
    "ACGL.NS": "Automobile Corporation of Goa Limited",
    ...
    "ADDIND.NS": "Addi Industries Limited",
    ...
    "AGL.NS": "Allcargo Global Limited",
    ...
    "AKCAPIT.NS": "AK Capital Services Limited",
    ...
    "ALFREDHE.NS": "Alfred Herbert India Limited",
    "ALGOQUANT.NS": "Algoquant Fintech Limited",
    ...
    "ALPINETEX.NS": "Alpine Texworld Limited",
    "ALUFLUOR.NS": "Alufluoride Limited",
    "AMAGI.NS": "Amagi Media Labs Limited",
    "AMAL.NS": "Amal Limited",
    "AMARJOTHI.NS": "Amarjothi Spinning Mills Limited",
    ...
    "ANDREWYU.NS": "Andrew Yule & Company Limited",
    "ANGELONE.NS": "Angel One Limited",
    "ANIKINDS.NS": "Anik Industries Limited",
    "ANNAPURNA.NS": "Annapurna Swadisht Limited",
    "ANNU.NS": "Annu Projects Limited",
    "ANSALBU.NS": "Ansal Buildwell Limited",
    ...
    "APOORVA.NS": "Apoorva Leasing Finance and Investment Company Limited",
    "APTUS.NS": "Aptus Value Housing Finance India Limited",
    "AQYLON.NS": "Aqylon Nexus Limited",
    "ARCHIDPLY.NS": "Archidply Industries Limited",
    "ARCHIES.NS": "Archies Limited",
    "ARCIL.NS": "Asset Reconstruction Company (India) Limited",
    "ARCL.NS": "ARCL Organics Limited",
    "ARDEE.NS": "Ardee Industries Limited",
    ...
    "ARIS.NS": "Arisinfra Solutions Limited",
    ...
    "ARYAMAN.NS": "Aryaman Financial Services Limited",
    ...
    "ASIANTNE.NS": "Asian Tea & Exports Limited",
    "ASKAUTOLTD.NS": "ASK Automotive Limited",
    "ASPINWALL.NS": "Aspinwall and Company Limited",
    "ASSAMENT.NS": "Assam Entrade Limited",
    "ASTAR.NS": "Asian Star Company Limited",
    ...
    "AVANCE.NS": "Avance Technologies Limited",
    ...
    "AXTEL.NS": "Axtel Industries Limited",
    "AYE.NS": "Aye Finance Limited",
    "AYMSYNTEX.NS": "AYM Syntex Limited",
    "AZAD.NS": "Azad Engineering Limited",
    "AZADIND.NS": "Azad India Mobility Limited",
    ...
    "BAJAJST.NS": "Bajaj Steel Industries Limited",
    ...
    "BCPL.NS": "BCPL Railway Infrastructure Limited",
    ...
    "BEEKAY.NS": "Beekay Steel Industries Limited",
    ...
    "BHARATCOAL.NS": "Bharat Coking Coal Limited",
    ...
    "BIMETAL.NS": "Bimetal Bearings Limited",
    ...
    "BLEL.NS": "Behari Lal Engineering Limited",
    "BLIL.NS": "Balmer Lawrie Investments Limited",
    "BLKASHYAP.NS": "B. L. Kashyap and Sons Limited",
    "BLS.NS": "BLS International Services Limited",
    "BLSE.NS": "BLS E-Services Limited",
    "BLUECLOUDS.NS": "Blue Cloud Softech Solutions Limited",
    ...
    "BOSCH-HCIL.NS": "BOSCH HOME COMFORT INDIA LIMITED",
    "BOSCHLTD.NS": "Bosch Limited",
    "BPCL.NS": "Bharat Petroleum Corporation Limited",
    "BPL.NS": "BPL Limited",
    "BPLPHARMA.NS": "Bharat Parenterals Limited",
    "BRAHMINFRA.NS": "Brahmaputra Infrastructure Limited",
    "BRIGADE.NS": "Brigade Enterprises Limited",
    "BRIGHOTEL.NS": "Brigade Hotel Ventures Limited",
    "BRIGHTBR.NS": "Bright Brothers Limited",
    ...
    "BUILDPRO.NS": "Shankara Buildpro Limited",
    ...
    "CAPILLARY.NS": "Capillary Technologies India Limited",
    ...
    "CEINSYS.NS": "Ceinsys Tech Limited",
    ...
    "CGVAK.NS": "CG Vak Software & Exports Limited",
    ...
    "CHEMCRUX.NS": "Chemcrux Enterprises Limited",
    ...
    "CLEANMAX.NS": "Clean Max Enviro Energy Solutions Limited",
    "CLEDUCATE.NS": "CL Educate Limited",
    "CLSEL.NS": "Chaman Lal Setia Exports Limited",
    "CMLL.NS": "Caliber Mining and Logistics Limited",
    "CMPDI.NS": "Central Mine Planning & Design Institute Limited",
    "CMRGREEN.NS": "CMR Green Technologies Limited",
    "CMSINFO.NS": "CMS Info Systems Limited",
    "CNL.NS": "Creative Newtech Limited",
    "COALINDIA.NS": "Coal India Limited",
    "COASTCORP.NS": "Coastal Corporation Limited",
    "COCHINSHIP.NS": "Cochin Shipyard Limited",
    "COCKERILL.NS": "John Cockerill India Limited",
    ...
    "COMFINTE.NS": "Comfort Intech Limited",
    "COMPEAU.NS": "Competent Automobiles Company Limited",
    ...
    "CSM.NS": "CSM Technologies Limited",
    ...
    "DCMSIL.NS": "DCM Shriram International Limited",
    ...
    "DECNGOLD.NS": "Deccan Gold Mines Limited",
    "DEEDEV.NS": "DEE Development Engineers Limited",
    "DEEP.NS": "Deep Polymers Limited",
    "DEEPA.NS": "Deepa Jewellers Limited",
    ...
    "DHATRE.NS": "Dhatre Udyog Limited",
    "DHOOTTRANS.NS": "Dhoot Transmission Limited",
    ...
    "DOLLEX.NS": "Dollex Agrotech Limited",
    ...
    "DRAGARWQ.NS": "Dr Agarwals Eye Hospital Limited",
    ...
    "EASTWEST.NS": "East West Freight Carriers Limited",
    "EBGNG.NS": "GNG Electronics Limited",
    "ECLERX.NS": "eClerx Services Limited",
    "ECORECO.NS": "Eco Recycling Limited",
    ...
    "EKI.NS": "EKI Energy Services Limited",
    "ELANTAS.NS": "Elantas Beck India Limited",
    "ELCIDIN.NS": "EL CID Investments Limited",
    ...
    "ELITECON.NS": "Elitecon International Limited",
    "ELLEN.NS": "Ellenbarrie Industrial Gases Limited",
    "ELPROINTL.NS": "Elpro International Limited",
    ...
    "EMMVEE.NS": "Emmvee Photovoltaic Power Limited",
    "EMPIND.NS": "Empire Industries Limited",
    "EMPOWER.NS": "Empower India Limited",
    ...
    "ENKEIWHEL.NS": "Enkei Wheels (India) Limited",
    ...
    "ESDS.NS": "ESDS Software Solution Limited",
    ...
    "EXCELSOFT.NS": "Excelsoft Technologies Limited",
    ...
    "FRACTAL.NS": "Fractal Analytics Limited",
    "FREDUN.NS": "Fredun Pharmaceuticals Limited",
    "FRONTSP.NS": "Frontier Springs Limited",
    ...
    "GAJA.NS": "Gaja Alternative Asset Management Limited",
    ...
    "GAUDIUMIVF.NS": "Gaudium IVF and Women Health Limited",
    ...
    "GKB.NS": "GKB Ophthalmics Limited",
    "GKENERGY.NS": "GK Energy Limited",
    "GKSL.NS": "Gujarat Kidney And Super Speciality Limited",
    "GKWLIMITED.NS": "GKW Limited",
    "GLAND.NS": "Gland Pharma Limited",
    "GLASSWALL.NS": "Glass Wall Systems (India) Limited",
    ...
    "GLOBE.NS": "GLOBE ENTERPRISES (INDIA) LIMITED",
    ...
    "GNRL.NS": "Gujarat Natural Resources Limited",
    ...
    "GRANDOAK.NS": "Grand Oak Canyons Distillery Limited",
    "GRANULES.NS": "Granules India Limited",
    "GRAPHITE.NS": "Graphite India Limited",
    "GRASIM.NS": "Grasim Industries Limited",
    "GRAUWEIL.NS": "Grauer & Weil India Limited",
    ...
    "GROWW.NS": "Billionbrains Garage Ventures Limited",
    ...
    "GSPCROP.NS": "GSP Crop Science Limited",
    ...
    "GUJENERGY.NS": "GUJARAT ENERGY LIMITED",
    ...
    "GYFTR.NS": "Gyftr Limited",
    "HAL.NS": "Hindustan Aeronautics Limited",
    "HALDER.NS": "Halder Venture Limited",
    "HALEOSLABS.NS": "HALEOS LABS LIMITED",
    "HAMPTON.NS": "Hampton Sky Realty Limited",
    ...
    "HAWKINCOOK.NS": "Hawkins Cookers Limited",
    "HAZOOR.NS": "Hazoor Multi Projects Limited",
    "HBESD.NS": "HB Estate Developers Limited",
    "HBLENGINE.NS": "HBL Engineering Limited",
    "HBPOR.NS": "HB Portfolio Limited",
    ...
    "HEALTHX.NS": "Health X Platform Limited",
    ...
    "HINDADH.NS": "Hindustan Adhesives Limited",
    "HINDALCO.NS": "Hindalco Industries Limited",
    "HINDALUMI.NS": "Hind Aluminium Industries Limited",
    ...
    "IBULLSLTD.NS": "Indiabulls Limited",
    "ICEMAKE.NS": "Ice Make Refrigeration Limited",
    "ICICIAMC.NS": "ICICI Prudential Asset Management Company Limited",
    ...
    "IGIL.NS": "International Gemological Institute Limited",
    ...
    "INA.NS": "Insolation Energy Limited",
    ...
    "INDOKEM.NS": "Indokem Limited",
    "INDOMIM.NS": "INDO-MIM Limited",
    ...
    "INDPRUD.NS": "Industrial & Prudential Investment Company Limited",
    ...
    "INNOVISION.NS": "Innovision Limited",
    ...
    "IRIS.NS": "IRIS RegTech Solutions Limited",
    ...
    "JNPR.NS": "Juniper Green Energy Limited",
    ...
    "JYOTIRES.NS": "Jyoti Resins & Adhesives Limited",
    ...
    "KAMAHOLD.NS": "Kama Holdings Limited",
    "KAMANWALA.NS": "Kamanwala Housing Construction Limited",
    "KAMATHOTEL.NS": "Kamat Hotels (I) Limited",
    "KAMOPAINTS.NS": "Kamdhenu Ventures Limited",
    "KANANIIND.NS": "Kanani Industries Limited",
    "KANCHI.NS": "Kanchi Karpooram Limited",
    "KANCOTEA.NS": "Kanco Tea & Industries Limited",
    "KANOHAR.NS": "Kanohar Electricals Limited",
    "KANPRPLA.NS": "Kanpur Plastipack Limited",
    "KANSAINER.NS": "Kansai Nerolac Paints Limited",
    "KAPSTON.NS": "Kapston Services Limited",
    "KARAMTARA.NS": "Karamtara Engineering Limited",
    ...
    "KDGREEN.NS": "KD Green Industries Limited",
    ...
    "KIRLFER.NS": "Kirloskar Ferrous Industries Limited",
    ...
    "KISSHT.NS": "OnEMI Technology Solutions Limited",
    "KITEX.NS": "Kitex Garments Limited",
    "KJMCFIN.NS": "KJMC Financial Services Limited",
    "KKCL.NS": "Kewal Kiran Clothing Limited",
    "KLBRENG-B.NS": "Kilburn Engineering Limited",
    "KMCSHIL.NS": "K M C Speciality Hospitals (India) Limited",
    "KMEW.NS": "Knowledge Marine & Engineering Works Limited",
    "KMSUGAR.NS": "K.M.Sugar Mills Limited",
    "KNACK.NS": "Knack Packaging Limited",
    "KNAGRI.NS": "KN Agri Resources Limited",
    ...
    "KOTIC.NS": "Kothari Industrial Corporation Limited",
    ...
    "KPL.NS": "Kwality Pharmaceuticals Limited",
    ...
    "KRISHNADEF.NS": "Krishna Defence And Allied Industries Limited",
    ...
    "KSE.NS": "KSE Limited",
    "KSHINTL.NS": "KSH International Limited",
    ...
    "KUSUMGAR.NS": "Kusumgar Limited",
    "KWIL.NS": "Kwality Wall's (India) Limited",
    "LAGNAM.NS": "Lagnam Spintex Limited",
    "LAHOTIOV.NS": "Lahoti Overseas Limited",
    "LAKSHMIMIL.NS": "Lakshmi Mills Company Limited",
    "LAL.NS": "Lorenzini Apparels Limited",
    "LALITHAA.NS": "Lalithaa Jewellery Mart Limited",
    "LALPATHLAB.NS": "Dr. Lal Path Labs Ltd.",
    "LAMBODHARA.NS": "Lambodhara Textiles Limited",
    "LANCER.NS": "Lancer Container Lines Limited",
    "LANDMARK.NS": "Landmark Cars Limited",
    "LANDSMILL.NS": "Landsmill Green Limited",
    "LAOPALA.NS": "La Opala RG Limited",
    "LASERPOWER.NS": "Laser Power & Infra Limited",
    ...
    "LCCPROJECT.NS": "LCC Projects Limited",
    "LCL.NS": "Lohia Corp Limited",
    "LEAPIND.NS": "LEAP India Limited",
    "LEMERITE.NS": "Le Merite Exports Limited",
    "LEMONTREE.NS": "Lemon Tree Hotels Limited",
    "LENSKART.NS": "Lenskart Solutions Limited",
    ...
    "LKPSEC.NS": "LKP Securities Limited",
    ...
    "LOTUSCHO.NS": "Lotus Chocolate Company Limited",
    ...
    "LUMINO.NS": "Lumino Industries Limited",
    ...
    "MADHAVIPL.NS": "Madhav Infra Projects Limited",
    "MADRASFERT.NS": "Madras Fertilizers Limited",
    "MAFATIND.NS": "Mafatlal Industries Limited",
    ...
    "MAKERSL.NS": "Makers Laboratories Limited",
    ...
    "MANIPALHOS.NS": "Manipal Health Enterprises Limited",
    ...
    "MCCHRLS-B.NS": "Mac Charles India Limited",
    "MCL.NS": "M TEK COPPER LIMITED",
    ...
    "MERCANTILE.NS": "Mercantile Ventures Limited",
    "MERCURYEV.NS": "Mercury Ev-Tech Limited",
    "METROBRAND.NS": "Metro Brands Limited",
    "METROGLOBL.NS": "Metroglobal Limited",
    ...
    "MIIL.NS": "Meghna Infracon Infrastructure Limited",
    "MILKYMIST.NS": "Milky Mist Dairy Food Limited",
    ...
    "MPIMANIPAL.NS": "Manipal Payment and Identity Solutions Limited",
    "MPSLTD.NS": "MPS Limited",
    "MRF.NS": "MRF Limited",
    "MRPL.NS": "Mangalore Refinery and Petrochemicals Limited",
    "MSL.NS": "Mangalam Seeds Limited",
    ...
    "MUKESHB.NS": "Mukesh Babu Financial Services Limited",
    ...
    "MVELECTRO.NS": "MV Electrosystems Limited",
    ...
    "NATIONSTD.NS": "National Standard (India) Limited",
    ...
    "NEPHROPLUS.NS": "Nephrocare Health Services Limited",
    ...
    "NICCOPAR.NS": "Nicco Parks & Resorts Limited",
    ...
    "NTCIND.NS": "NTC Industries Limited",
    ...
    "OMNI.NS": "Omnitech Engineering Limited",
    "OMPOWER.NS": "Om Power Transmission Limited",
    "ONEGLOBAL.NS": "One Global Service Provider Limited",
    ...
    "ONIDA.NS": "Onida Electronics Limited",
    "ONIXSOLAR.NS": "Onix Solar Energy Limited",
    "ONWARDTEC.NS": "Onward Technologies Limited",
    "OPTIEMUS.NS": "Optiemus Infracom Limited",
    "OPTIFIN.NS": "Optimus Finance Limited",
    ...
    "ORIRAIL.NS": "Oriental Rail Infrastructure Limited",
    "ORISSAMINE.NS": "The Orissa Minerals Development Company Limited",
    "ORKLAINDIA.NS": "Orkla India Limited",
    ...
    "PACIFICI.NS": "Pacific Industries Limited",
    ...
    "PANCHMAHQ.NS": "Panchmahal Steel Limited",
    "PANORAMA.NS": "Panorama Studios International Limited",
    ...
    "PARKHOSPS.NS": "Park Medi World Limited",
    "PARKHOTELS.NS": "Apeejay Surrendra Park Hotels Limited",
    "PARNAXLAB.NS": "Parnax Lab Limited",
    ...
    "PERMAGN.NS": "Permanent Magnets Limited",
    "PERNIASPOP.NS": "Purple Style Labs Limited",
    ...
    "PHOENXINTL.NS": "Phoenix International Limited",
    ...
    "PINELABS.NS": "Pine Labs Limited",
    "PIONEEREMB.NS": "Pioneer Embroideries Limited",
    "PIRAMALFIN.NS": "Piramal Finance Limited",
    ...
    "PRANAV.NS": "Pranav Constructions Limited",
    "PRASOLCHEM.NS": "Prasol Chemicals Limited",
    "PRAVEG.NS": "Praveg Limited",
    ...
    "PREMCO.NS": "Premco Global Limited",
    ...
    "PRISMX.NS": "Prismx Global Ventures Limited",
    ...
    "QUINT.NS": "Quint Digital Limited",
    ...
    "RAJPALAYAM.NS": "Rajapalayam Mills Limited",
    ...
    "RAMBHAJO.NS": "Advit Jewels Limited",
    ...
    "RENTOMOJO.NS": "Rentomojo Limited",
    ...
    "RIR.NS": "RIR Power Electronics Limited",
    ...
    "RMC.NS": "RMC Switchgears Limited",
    ...
    "RRECL.NS": "RDB Real Estate Constructions Limited",
    "RRIL.NS": "RRIL Limited",
    "RRKABEL.NS": "R R Kabel Limited",
    "RSL.NS": "Rajputana Stainless Limited",
    ...
    "RTSPOWR.NS": "RTS Power Corporation Limited",
    ...
    "RUDRA.NS": "Rudra Global Infra Products Limited",
    ...
    "SAMBANDAM.NS": "Sambandam Spinning Mills Limited",
    ...
    "SAPPL.NS": "Shree Ajit Pulp & Paper Limited",
    ...
    "SAYAJIIND.NS": "Sayaji Industries Limited",
    ...
    "SBIFUNDS.NS": "SBI Funds Management Limited",
    ...
    "SEDEMAC.NS": "SEDEMAC Mechatronics Limited",
    "SEIL.NS": "Shanti Educational Initiatives Limited",
    "SEJALLTD.NS": "Sejal Glass Limited",
    "SEKURITIND.NS": "Saint Gobain Sekurit India Limited",
    ...
    "SETL.NS": "Standard Engineering Technology Limited",
    "SFL.NS": "Sheela Foam Limited",
    "SGFIN.NS": "SG Finserve Limited",
    "SGIL.NS": "Synergy Green Industries Limited",
    "SGL.NS": "STL Global Limited",
    "SGLRES.NS": "SGL Resources Limited",
    "SGMART.NS": "SG Mart Limited",
    "SGRL.NS": "Shree Ganesh Remedies Limited",
    "SHADOWFAX.NS": "Shadowfax Technologies Limited",
    ...
    "SHANKESH.NS": "Shankesh Jewellers Limited",
    ...
    "SHBAJRG.NS": "Shri Bajrang Alliance Limited",
    "SHERVANI.NS": "Shervani Industrial Syndicate Limited",
    "SHILCTECH.NS": "Shilchar Technologies Limited",
    "SHILGRAVQ.NS": "Shilp Gravures Limited",
    "SHILPAMED.NS": "Shilpa Medicare Limited",
    "SHINDL.NS": "Sharat Industries Limited",
    "SHIPROCKET.NS": "Shiprocket Limited",
    "SHIVAAGRO.NS": "Shiva Global Agro Industries Limited",
    "SHIVACEM.NS": "Shiva Cement Limited",
    ...
    "SHIVAUM.NS": "Shiv Aum Steels Limited",
    "SHK.NS": "S H Kelkar and Company Limited",
    "SHOPERSTOP.NS": "Shoppers Stop Limited",
    "SHRADDHA.NS": "Shraddha Prime Projects Limited",
    "SHRADHA.NS": "Shradha Realty Limited",
    ...
    "SIKA.NS": "Sika Interplant Systems Limited",
    ...
    "SONAL.NS": "Sonal Mercantile Limited",
    ...
    "SRTL.NS": "Shree Ram Twistex Limited",
    ...
    "STEAMHOUSE.NS": "Steamhouse India Limited",
    ...
    "STLSTRINF.NS": "Steel Strips Infrastructures Limited",
    "STOVEKRAFT.NS": "Stove Kraft Limited",
    "STUDDS.NS": "Studds Accessories Limited",
    ...
    "SUNLOC.NS": "Sunil Healthcare Limited",
    "SUNPHARMA.NS": "Sun Pharmaceutical Industries Limited",
    "SUNRAKSHAK.NS": "Sunrakshakk Industries India Limited",
    "SUNSHIEL.NS": "Sunshield Chemicals Limited",
    "SUNSHINE.NS": "Sunshine Pictures Limited",
    ...
    "SURYALA.NS": "Suryalata Spinning Mills Limited",
    ...
    "SVGLOBAL.NS": "S V Global Mill Limited",
    ...
    "SWARNSAR.NS": "Swarnsarita Jewels India Limited",
    ...
    "SYMBIOTEC.NS": "Symbiotec Pharmalab Limited",
    ...
    "TECHNOCRAF.NS": "Technocraft Ventures Limited",
    "TECHNOE.NS": "Techno Electric & Engineering Company Limited",
    "TECHNVISN.NS": "TechNVision Ventures Limited",
    ...
    "TEMPSENS.NS": "Tempsens Instruments (India) Limited",
    "TENNIND.NS": "Tenneco Clean Air India Limited",
    "TERAI.NS": "Terai Tea Company Limited",
    ...
    "TGVSL.NS": "TGV Sraac Limited",
    "THACKER.NS": "Thacker & Company Limited",
    "THAKDEV.NS": "Thakkers Developers Limited",
    ...
    "TIMEX.NS": "Timex Group India Limited",
    ...
    "TOYAMSL.NS": "Toyam Sports Limited",
    "TPLPLASTEH.NS": "TPL Plastech Limited",
    "TRACXN.NS": "Tracxn Technologies Limited",
    "TRANSCOR.NS": "Transcorp International Limited",
    ...
    "TRITONV.NS": "Triton Valves Limited",
    ...
    "TURTLEMINT.NS": "Turtlemint Fintech Solutions Limited",
    "TUTIALKA.NS": "Tuticorin Alkali Chemicals & Fertilizers Limited",
    ...
    "UCOBANK.NS": "UCO Bank",
    "UDAYJEW.NS": "Uday Jewellery Industries Limited",
    ...
    "ULTRAMAR.NS": "Ultramarine & Pigments Limited",
    ...
    "VASUPRADA.NS": "Shri Vasuprada Plantations Limited",
    "VASWANI.NS": "Vaswani Industries Limited",
    "VBL.NS": "Varun Beverages Limited",
    "VEDAVAAG.NS": "VEDAVAAG Systems Limited",
    "VEDL.NS": "Vedanta Limited",
    "VEDPOWER.NS": "Vedanta Power Limited",
    ...
    "VGCL.NS": "Vibrant Global Capital Limited",
    ...
    "VIDYAWIRES.NS": "Vidya Wires Limited",
    "VIJAYA.NS": "Vijaya Diagnostic Centre Limited",
    "VIJSOLX.NS": "Vijay Solvex Limited",
    ...
    "VIRAT.NS": "Virat Industries Limited",
    "VIRINCHI.NS": "Virinchi Limited",
    "VISACHROME.NS": "VISA Chrome Limited",
    ...
    "VISL.NS": "Vedanta Iron and Steel Limited",
    "VITAL.NS": "Vital Chemtech Limited",
    "VIVIANA.NS": "Viviana Power Tech Limited",
    "VIVIDHA.NS": "Visagar Polytex Limited",
    "VIVOBIOT.NS": "Vivo Bio Tech Limited",
    "VIYASH.NS": "Viyash Scientific Limited",
    ...
    "VOEPL.NS": "Virtuoso Optoelectronics Limited",
    "VOGL.NS": "Vedanta Oil and Gas Limited",
    "VOITHPAPR.NS": "Voith Paper Fabrics India Limited",
    ...
    "WELSPLSOL.NS": "Welspun Specialty Solutions Limited",
    ...
    "WHBRADY.NS": "WH Brady & Company Limited",
    ...
    "XTRANET.NS": "Xtranet Technologies Limited",
    ...
    "ZFSTEERING.NS": "ZF Steering Gear (India) Limited",
    ...
    "ZSARACOM.NS": "Saraswati Commercial India Limited",
